...
const { schema, indexes } = require('../schemas/mongo/order-operation-record');
...
const model = createModel(config.SERVER.DATABASE_TYPE, 'order_operation_records', mongooseSchema);
