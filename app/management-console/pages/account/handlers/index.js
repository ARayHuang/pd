...
const PREFIX_CLASS = 'account-handler-page';
const { CONSUMER } = DepartmentTypeEnums;
const {
	fetchUsersAction,
	createStaffAction,
	updateStaffAction,
...
AccountHandlerPage.propTypes = propTypes;
...
function mapDispatchToProps(dispatch) {
	return {
		fetchUsersAction: (...args) => dispatch(fetchUsersAction(STAFF, CONSUMER, ...args)),
...
export default connect(mapStateToProps, mapDispatchToProps)(AccountHandlerPage);
